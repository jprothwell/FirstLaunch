#
# Be sure to run `pod lib lint FirstLaunch.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'FirstLaunch'
  s.version          = '0.1.0'
  s.summary          = 'A short description of FirstLaunch.'
...
TODO: Add long description of the pod here.
  ...
  s.source_files = 'FirstLaunch/Classes/**/*'
  
  # s.resource_bundles = {
  #   'FirstLaunch' => ['FirstLaunch/Assets/*.png']
  # }
